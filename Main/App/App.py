...
# core package used in this project
import pandas as pd
...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Soundu@19/11',db='cv')
...
def run():
    ...
    link = '<b>developed by <a href="https://soundu19.github.io/Portfolio-Pro2/" style="text-decoration: none; color: #021659;">Soundarya H S</a></b>' 
